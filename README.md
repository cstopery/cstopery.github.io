...
> 
> 更为详细的教程戳这 [wiki](https://github.com/cstopery/cstopery.github.io/wiki/%E5%8D%9A%E5%AE%A2%E6%90%AD%E5%BB%BA%E8%AF%A6%E7%BB%86%E6%95%99%E7%A8%8B)
> 
### [我的博客在这里 &rarr;](https://cstopery.github.io)
...
```
# Site settings
title: Cst. Blog                    # 你的博客网站标题
SEOTitle: 大涛哥的博客 | Cst. Blog		# SEO 标题
description: "Hey,欢迎来到大涛哥的blog"	   	   # 随便说点，描述一下

# SNS settings      
github_username: cstopery     # 你的github账号
...
在下面输入的社交账号，没有的添加的不会显示在侧边框中。新加入了[简书](https:/www.jianshu.com)链接, <http://www.jianshu.com/u/e71990ada2fd>
	...
	zhihu_username:     cstopery
	facebook_username:  cstopery
	github_username:    cstopery
...
遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/cstopery/cstopery.github.io/blob/master/LICENSE)。
